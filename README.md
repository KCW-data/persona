...
2026.7.24 강의 실습용 Streamlit 앱입니다. 인구통계학적 정보, 정치 관심, 제도 신뢰, 사회 현안 태도, 정보 이용 방식, 진로 협력·창업·시니어 협업 성향을 입력하고 Gemini API로 페르소나를 분석합니다.
...
4. 주니어 취업 진입장벽, 실무 경험 격차, 시니어 멘토링, 창업, 지역 협력 등 10개 진로·협업 질문을 확인한다.
5. 페르소나가 실제 응답자처럼 각 질문에 대해 1~5점 척도로 응답한다.
...
- 진로 협력·창업·시니어 협업 성향: 취업 진입장벽, 포트폴리오 피드백, 시니어 멘토링, 세대 협업, 팀 창업, 지역 협력, 공정 보상, 실패 공유, 협업 역량
- 정보 이용: 신뢰하는 정보 출처와 출처 검증 성향

진로·협업 응답 생성에서는 사회 현안 태도와 진로 협력 문항을 함께 앵커로 사용합니다. 10개 질문이 모두 3점으로 나오는 응답은 실패로 처리되며, 3점 응답은 최대 2개까지만 허용합니다.
...
- `data/evaluations.csv`: 진로·협업 질문, 페르소나 응답, 사용자 판정, 판정 이유 기록
